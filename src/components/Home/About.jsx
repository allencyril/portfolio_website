...
const About = () => {
    return (
        ...
        //          Hi, my name is <span className="yellow">Allen Cyril </span>
        //          and I'm from <span className="yellow"> Kerala India</span>
        //         <br />
        //         <br />
        //         Currently i am pursuring Ontario Graduate Certificate in Web Development from Conestoga College.
        //         <br />
        //         <br />
        //           As a
        ...
        //     <Row>
              <Col md={12} className="home-about-social">
                ...
                <ul className="home-about-social-links">
                  ...
                  <li className="social-icons">
                    <a
                      href="https://www.instagram.com/seewhygram/"
                      target="_blank"
                      rel="noreferrer"
                      className="icon-colour home-social-icons"
